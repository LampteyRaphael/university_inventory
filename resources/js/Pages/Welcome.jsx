...
import studentAnimation from "../../../Shopping.json"; // You'll need to add this JSON file
...
export default function Welcome({ auth }) {
  ...
  return (
    <>
                ...
                >
                  <Stack spacing={3} alignItems="center">
                    ...
                    <Typography variant="body2" color="text.secondary" textAlign="center" sx={{ mt: 2 }}>
                      Secure access to manage all university assets and equipment.
                    </Typography>
                  </Stack>
                </Card>
              </motion.div>
      ...
      {/* Features section */}
      <Box sx={{ py: 8, bgcolor: 'rgba(255, 255, 255, 0.95)', position: 'relative', zIndex: 1 }}>
        <Container maxWidth="lg">
          <motion.div
            initial={{ opacity: 0 }}
      ...
      {/* Footer */}
      <Box sx={{ bgcolor: 'primary.main', color: 'white', py: 4, position: 'relative', zIndex: 1 }}>
        <Container maxWidth="lg">
