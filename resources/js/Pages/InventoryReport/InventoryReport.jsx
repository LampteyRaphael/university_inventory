...
const ModernReportGenerator = ({ auth, categories: initialCategories, locations: initialLocations }) => {
  ...
  useEffect(() => {
    ...
    console.log('Report Data Structure:', {
      ...
      hasTrends: !!reportData?.trends,
      trendsKeys: reportData?.trends ? Object.keys(reportData.trends) : [],
            ...
            <CardContent>
              <Box display="flex" alignItems="center">
                ...
                <Box>
                  ...
                  <Typography variant="h6">{displaySummary.total_transactions?.toLocaleString() || 0}</Typography>
                </Box>
              </Box>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Box display="flex" alignItems="center">
                ...
                <Box>
                  ...
                  <Typography variant="h6">${displaySummary.total_value?.toLocaleString() || 0}</Typography>
                </Box>
              </Box>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Box display="flex" alignItems="center">
                ...
                <Box>
                  ...
                  <Typography variant="h6">{displaySummary.incoming_stock?.toLocaleString() || 0}</Typography>
                </Box>
              </Box>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Box display="flex" alignItems="center">
                ...
                <Box>
                  ...
                  <Typography variant="h6">{displaySummary.outgoing_stock?.toLocaleString() || 0}</Typography>
                </Box>
              </Box>
            </CardContent>
          </Card>
